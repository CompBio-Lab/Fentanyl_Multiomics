...
keep_cellann <- rna_atac@meta.data %>%
                filter(aba_classification$subclass_label %in% more_20_celltypes)
...
DoHeatmap(gex_atac, features = markers$gene, assay = "SCT", angle = 90, size = 1.5, vjust = 0.6, hjust = 0.2) + NoLegend() + theme(axis.text.y = element_text(size = 5.5, face = "bold")) 
```
