...
# extract SCT counts 
sct_counts <- GetAssayData(rna_atac, assay = "SCT", slot = "counts")
...
#assays(sce)$vstresiduals <- vst(counts(sce), latent_var = "percent.mt", verbosity = FALSE)$y
# set negative counts to zero 
#assays(sce)$vstresiduals <- pmax(assays(sce)$vstresiduals, 0)
